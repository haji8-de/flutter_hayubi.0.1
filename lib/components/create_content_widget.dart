...
class CreateContentWidget extends StatefulWidget {
  const CreateContentWidget({
    ...
    this.userEmail,
    String? postType,
  })  : this.postType = postType ?? 'Job',
        super(key: key);

  final DocumentReference? loginUser;
              ...
              Padding(
                ...
                child: FutureBuilder<List<PostTypeRecord>>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    List<PostTypeRecord> dropDownPostTypeRecordList =
                        snapshot.data!;
                    return FlutterFlowDropDown<String>(
                      controller: _model.dropDownValueController ??=
                          FormFieldController<String>(null),
                      options: dropDownPostTypeRecordList
                          .map((e) => e.postType)
                          .toList(),
                      onChanged: (val) =>
